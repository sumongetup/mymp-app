...
Story _video(String id, String title, String member, {bool picture = true}) => Story(
      id: id,
      date: '2026-09-17',
      dateLabel: '',
      lead: StoryLink(title: title, url: 'https://youtube.com/watch?v=$id', source: 'চ্যানেল'),
...
void main() {
  test('videos about a member come before bulletins, at most two per member, only with a picture', () {
